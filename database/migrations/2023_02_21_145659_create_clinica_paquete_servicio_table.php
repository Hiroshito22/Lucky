...
class CreateClinicaPaqueteServicioTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('clinica_paquete_servicio', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('clinica_paquete_servicio');
    }
}
