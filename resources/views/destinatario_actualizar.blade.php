...
<form action="{{ route('destinatario_actualizar') }}" method="post">
    @csrf
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="contact-info">
                    ...
                    <h2>Actualiza a tu destinatario !!!</h2>
                    <h4>Cada destinatario es importante para la empresa . . .</h4>
                </div>
            </div>
            <div class="col-md-9">
                <div class="contact-form">
                    <div class="form-group">
                        <label class="control-label col-sm-6" for="id">Selecciona el Destinatario a Actualizar:</label>
                        <div class="col-sm-10">
                    ...
                    <hr>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="destinatario">Nuevo nombre:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="destinatario" placeholder="Escribe un nuevo destinatario" name="destinatario">
                        </div>
                    </div>
