...
<form action="{{ route('proveedor_eliminar') }}" method="post">
    @csrf
            ...
            <div class="col-md-9">
                <div class="contact-form">
                    <div class="form-group">
                        <label class="control-label col-sm-6" for="id">Selecciona el Proveedor para eliminar:</label>
                        <div class="col-sm-10">
